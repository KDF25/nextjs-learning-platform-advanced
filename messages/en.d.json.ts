...
declare const messages: {
	...
	"LoginPage": {
		"form": {
			...
			"signInGoogle": {
				"success": "Signed in with Google, you will be redirected ...",
			...
			"chapters": {
				...
				"add": {
					"chapter": {
						...
						"description": "What would you like to call this chapter?"
					},

					"lesson": {
						"title": "Create a new Lesson",
						"description": "What would you like to call this lesson?"
					}
				},
	...
	"StudentDashboardPage": {
		...
		"available": {
			...
			"empty": {
				...
				"description": "There are currently no available courses. Check back later for new courses!"
			}
		}
	},
